...
`
  ...
  function createMesh(device, gltfMesh, options) {
    if (!gltfMesh._mesh) {
      ...
      const primitives = gltfPrimitives.map((gltfPrimitive, i2) => createPrimitive(device, gltfPrimitive, i2, gltfMesh, options));
  ...
  function createPrimitive(device, gltfPrimitive, i2, gltfMesh, options) {
  ...
  function linearInterpolate(target, path, start, stop, ratio) {
    ...
    if (path === "rotation") {
      ...
      for (let i2 = 0; i2 < scratchQuaternion.length; i2++) {
        target[path][i2] = scratchQuaternion[i2];
      }
    } else {
  ...
  var Vector3 = class extends Vector2 {
    ...
    transformByQuaternion(quaternion) {
      transformQuat3(this, this, quaternion);
      return this.check();
    }
  };
