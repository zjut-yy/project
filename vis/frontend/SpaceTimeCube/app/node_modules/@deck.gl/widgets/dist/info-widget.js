...
export class InfoWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        ...
        const ui = this.props.visible ? (_jsxs("div", { className: "popup-container", style: { position: 'absolute', left: 0, top: 0 }, children: [_jsx("div", { className: "popup-content", style: {
                        background,
                        padding: '10px',
                        position: 'relative',
                        // Include any additional styles
                        ...this.props.style
                    }, children: this.props.text }), _jsx("div", { className: "popup-arrow", style: { position: 'absolute', width: '0px', height: '0px' } })] })) : null;
