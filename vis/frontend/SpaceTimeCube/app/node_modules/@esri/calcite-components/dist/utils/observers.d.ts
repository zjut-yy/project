 ...
 * @param options
 */
export declare function updateRefObserver<T extends ObserverType>(observer: ObserverInstanceType<T> | undefined, oldTarget: Element | undefined, target: Element | undefined, options?: ObserverOptions<T>): void;
export {};
