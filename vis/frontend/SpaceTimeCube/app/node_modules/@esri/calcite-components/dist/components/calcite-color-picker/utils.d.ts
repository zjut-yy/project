...
export declare function getSliderWidth(availableWidth: number, activeStaticDimensions: (typeof STATIC_DIMENSIONS)[Scale], hasAlpha: boolean): number;
export declare function getColorFieldDimensions(availableWidth: number): Dimensions;
export {};
