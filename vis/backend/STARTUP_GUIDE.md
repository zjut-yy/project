...
```bash
/home/yangyu/MiniCPM-S/vis/backend/start_all_services.sh
```
...
```bash
/home/yangyu/MiniCPM-S/vis/backend/start_vllm_server.sh
```
...
cd /home/yangyu/MiniCPM-S/vis/backend
...
cd /home/yangyu/MiniCPM-S/vis/backend/model
...
- vLLM日志: `/home/yangyu/MiniCPM-S/vis/logs/vllm_server.log`
- 代理日志: `/home/yangyu/MiniCPM-S/vis/logs/agent_server.log`

```bash
# 实时查看vLLM日志
tail -f /home/yangyu/MiniCPM-S/vis/logs/vllm_server.log

# 实时查看代理日志
tail -f /home/yangyu/MiniCPM-S/vis/logs/agent_server.log
```
...
### 项目位置
- 项目根目录: `/home/yangyu/MiniCPM-S`
- 后端代码: `/home/yangyu/MiniCPM-S/vis/backend`
- 模型目录: `/home/yangyu/MiniCPM-S/vis/backend/model`
- 数据集:
  - VIRAT: `/home/yangyu/MiniCPM-S/vis/backend/dataset/VIRAT`
  - WildTrack: `/home/yangyu/MiniCPM-S/vis/backend/dataset/WildTrack_VIRAT`
...
A: 确保模型在正确位置：
```bash
ls -la /home/yangyu/MiniCPM-S/vis/backend/model/Qwen2.5-7B-Instruct/config.json
```
...
A: 确保vLLM已完全启动。检查日志：
```bash
tail -f /home/yangyu/MiniCPM-S/vis/logs/vllm_server.log | grep "Uvicorn running"
```

### Q: 数据集没有被发现
A: 对于WildTrack，需要先运行转换脚本：
```bash
cd /home/yangyu/MiniCPM-S/vis/backend/dataset
...
- WildTrack集成文档: `/home/yangyu/MiniCPM-S/vis/backend/dataset/README_WildTrack_Integration.md`
- 转换脚本: `/home/yangyu/MiniCPM-S/vis/backend/dataset/convert_wildtrack_to_virat.py`
